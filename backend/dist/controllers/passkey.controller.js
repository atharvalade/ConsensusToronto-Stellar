...
exports.verifyAuthentication = exports.generateAuthenticationOptions = exports.verifyRegistration = exports.generateRegistrationOptions = void 0;
const server_1 = require("@simplewebauthn/server");
const env_1 = require("../config/env");
// In-memory storage for user credentials (replace with database in production)
const users = new Map();
// Environment variables
const rpName = env_1.config.rpName;
const rpID = env_1.config.rpId;
const rpIcon = env_1.config.rpIcon;
